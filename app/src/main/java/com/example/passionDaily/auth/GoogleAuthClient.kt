...
//
//        // UserDTO
//        val newUser = createUserDTOFromFirebaseUser(user)
//
//        // UserDTO -> User 변환 필요
//        runFirestoreTransaction(userDocRef, newUser)
//        // TODO: 현재까지 저장된 UserDTO를 SelectGenderAndAgeGroupScreen단으로 전달.
//        // TODO: SelectGenderAndAgeGroupScreen에서 Gender, AgeGroup 값 추가
//
//        saveOAuthInfo(user)
//    }
//
...
//     */
//    private fun createUserDTOFromFirebaseUser(firebaseUser: FirebaseUser): UserDTO {
//
//        var userDTO = UserDTO(
//            id = firebaseUser.uid,
